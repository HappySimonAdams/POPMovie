define([
        ...
        if (pass.render) {
            ...
            if (this._material !== this.material || !defined(this._overlayCommand)) {
                ...
                if (defined(this._overlayCommand)) {
                    this._overlayCommand.shaderProgram.dispose();
                }
     ...
     *
     * @example
     * quad = quad && quad.dispose();
     *
     * @see ViewportQuad#isDestroyed
     */
    ViewportQuad.prototype.dispose = function() {
        if (defined(this._overlayCommand)) {
            this._overlayCommand.shaderProgram = this._overlayCommand.shaderProgram && this._overlayCommand.shaderProgram.dispose();
        }
