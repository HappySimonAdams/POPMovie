define([
     ...
     *
     * @example
     * transitioner = transitioner && transitioner.dispose();
     */
    SceneTransitioner.prototype.dispose = function() {
    ...
    function destroyMorphHandler(transitioner) {
        ...
        transitioner._morphHandler = transitioner._morphHandler && transitioner._morphHandler.dispose();
    }
