define([
    ...
    defineProperties(BillboardCollection.prototype, {
        ...
        textureAtlas : {
            ...
            set : function(value) {
                if (this._textureAtlas !== value) {
                    this._textureAtlas = this._destroyTextureAtlas && this._textureAtlas && this._textureAtlas.dispose();
         ...
         * and explicitly dispose the atlas to avoid attempting to dispose it multiple times.
         *
         * @memberof BillboardCollection.prototype
         * @type {Boolean}
         * @private
    ...
    BillboardCollection.prototype.update = function(frameState) {
        ...
        if (createVertexArray || (!picking && this.computeNewBuffersUsage())) {
            ...
            this._vaf = this._vaf && this._vaf.dispose();
     ...
     *
     * @example
     * billboards = billboards && billboards.dispose();
     *
     * @see BillboardCollection#isDestroyed
     */
    BillboardCollection.prototype.dispose = function() {
        ...
        this._textureAtlas = this._destroyTextureAtlas && this._textureAtlas && this._textureAtlas.dispose();
        this._sp = this._sp && this._sp.dispose();
        this._spTranslucent = this._spTranslucent && this._spTranslucent.dispose();
        this._spPick = this._spPick && this._spPick.dispose();
        this._vaf = this._vaf && this._vaf.dispose();
        destroyBillboards(this._billboards);
