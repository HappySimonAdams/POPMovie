define([
     ...
     */
    ClassificationPrimitive.prototype.dispose = function() {
        this._primitive = this._primitive && this._primitive.dispose();
        this._sp = this._sp && this._sp.dispose();
        this._spPick = this._spPick && this._spPick.dispose();
        this._spColor = this._spColor && this._spColor.dispose();
