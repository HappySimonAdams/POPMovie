define([
    ...
    Instanced3DModel3DTileContent.prototype.dispose = function() {
        this._modelInstanceCollection = this._modelInstanceCollection && this._modelInstanceCollection.dispose();
