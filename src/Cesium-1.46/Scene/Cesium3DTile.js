define([
    ...
    Cesium3DTile.prototype.unloadContent = function() {
        ...
        this._content = this._content && this._content.dispose();
        ...
        this._debugBoundingVolume = this._debugBoundingVolume && this._debugBoundingVolume.dispose();
        this._debugContentBoundingVolume = this._debugContentBoundingVolume && this._debugContentBoundingVolume.dispose();
        this._debugViewerRequestVolume = this._debugViewerRequestVolume && this._debugViewerRequestVolume.dispose();
    };
    ...
    function applyDebugSettings(tile, tileset, frameState) {
        ...
        if (showVolume) {
            ...
            tile._debugBoundingVolume = tile._debugBoundingVolume.dispose();
        }
        ...
        if (tileset.debugShowContentBoundingVolume && hasContentBoundingVolume) {
            ...
            tile._debugContentBoundingVolume = tile._debugContentBoundingVolume.dispose();
        }
        ...
        if (tileset.debugShowViewerRequestVolume && defined(tile._viewerRequestVolume)) {
            ...
            tile._debugViewerRequestVolume = tile._debugViewerRequestVolume.dispose();
        }
    ...
    function updateContent(tile, tileset, frameState) {
        ...
        if (defined(expiredContent)) {
            ...
            // New content is ready, dispose expired content
            tile._expiredContent.dispose();
     ...
     * @private
     */
    Cesium3DTile.prototype.dispose = function() {
        // For the interval between new content being requested and downloaded, expiredContent === content, so don't dispose twice
        this._content = this._content && this._content.dispose();
        this._expiredContent = this._expiredContent && !this._expiredContent.isDestroyed() && this._expiredContent.dispose();
        this._debugBoundingVolume = this._debugBoundingVolume && this._debugBoundingVolume.dispose();
        this._debugContentBoundingVolume = this._debugContentBoundingVolume && this._debugContentBoundingVolume.dispose();
        this._debugViewerRequestVolume = this._debugViewerRequestVolume && this._debugViewerRequestVolume.dispose();
