define([
    ...
    InvertClassification.prototype.update = function(context) {
        ...
        if (textureChanged || previousFramebufferChanged) {
            this._texture = this._texture && this._texture.dispose();
            this._classifiedTexture = this._classifiedTexture && this._classifiedTexture.dispose();
            this._depthStencilTexture = this._depthStencilTexture && this._depthStencilTexture.dispose();
        ...
        if (!defined(this._fbo) || textureChanged || previousFramebufferChanged) {
            this._fbo = this._fbo && this._fbo.dispose();
            this._fboClassified = this._fboClassified && this._fboClassified.dispose();
        ...
        if (!defined(this._unclassifiedCommand) || previousFramebufferChanged) {
            if (defined(this._unclassifiedCommand)) {
                this._unclassifiedCommand.shaderProgram = this._unclassifiedCommand.shaderProgram && this._unclassifiedCommand.shaderProgram.dispose();
                this._classifiedCommand.shaderProgram = this._classifiedCommand.shaderProgram && this._classifiedCommand.shaderProgram.dispose();
            }
            ...
            if (defined(this._translucentCommand)) {
                this._translucentCommand.shaderProgram = this._translucentCommand.shaderProgram && this._translucentCommand.shaderProgram.dispose();
            }
            if (!defined(this._previousFramebuffer)) {
    ...
    InvertClassification.prototype.dispose = function() {
        this._fbo = this._fbo && this._fbo.dispose();
        this._texture = this._texture && this._texture.dispose();
        this._depthStencilTexture = this._depthStencilTexture && this._depthStencilTexture.dispose();
