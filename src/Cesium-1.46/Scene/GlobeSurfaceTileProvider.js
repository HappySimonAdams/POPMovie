define([
     ...
     */
    GlobeSurfaceTileProvider.prototype.dispose = function() {
        this._tileProvider = this._tileProvider && this._tileProvider.dispose();
    ...
    GlobeSurfaceTileProvider.prototype._onLayerRemoved = function(layer, index) {
        // dispose TileImagerys for this layer for all previously loaded tiles
        this._quadtree.forEachLoadedTile(function(tile) {
            var tileImageryCollection = tile.data.imagery;
