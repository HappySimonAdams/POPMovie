define([
     ...
     *
     * @example
     * skyAtmosphere = skyAtmosphere && skyAtmosphere.dispose();
     *
     * @see SkyAtmosphere#isDestroyed
     */
    SkyAtmosphere.prototype.dispose = function() {
        var command = this._command;
        command.vertexArray = command.vertexArray && command.vertexArray.dispose();
        this._spSkyFromSpace = this._spSkyFromSpace && this._spSkyFromSpace.dispose();
        this._spSkyFromAtmosphere = this._spSkyFromAtmosphere && this._spSkyFromAtmosphere.dispose();
        this._spSkyFromSpaceColorCorrect = this._spSkyFromSpaceColorCorrect && this._spSkyFromSpaceColorCorrect.dispose();
        this._spSkyFromAtmosphereColorCorrect = this._spSkyFromAtmosphereColorCorrect && this._spSkyFromAtmosphereColorCorrect.dispose();
