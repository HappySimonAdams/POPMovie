define([
     ...
     * @param {Number} [index] the index to add the layer at. If omitted, the layer will added on top of all existing layers.
     *
     ...
     * @param {Boolean} [destroy=true] whether to dispose the layers in addition to removing them.
     *
     ...
     *
     * @example
     * layerCollection = layerCollection && layerCollection.dispose();
     *
     * @see ImageryLayerCollection#isDestroyed
     */
    ImageryLayerCollection.prototype.dispose = function() {
        this.removeAll(true);
