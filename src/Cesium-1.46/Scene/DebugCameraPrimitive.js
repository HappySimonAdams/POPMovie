define([
    ...
    DebugCameraPrimitive.prototype.update = function(frameState) {
        ...
        if (this._updateOnChange) {
            ...
            for (i = 0; i < length; ++i) {
                outlinePrimitives[i] = outlinePrimitives[i] && outlinePrimitives[i].dispose();
                planesPrimitives[i] = planesPrimitives[i] && planesPrimitives[i].dispose();
            }
     ...
     */
    DebugCameraPrimitive.prototype.dispose = function() {
        var length = this._planesPrimitives.length;
        for (var i = 0; i < length; ++i) {
            this._outlinePrimitives[i] = this._outlinePrimitives[i] && this._outlinePrimitives[i].dispose();
            this._planesPrimitives[i] = this._planesPrimitives[i] && this._planesPrimitives[i].dispose();
        }
