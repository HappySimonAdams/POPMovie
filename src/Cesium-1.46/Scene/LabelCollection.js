define([
     ...
     *
     * @example
     * labels = labels && labels.dispose();
     *
     * @see LabelCollection#isDestroyed
     */
    LabelCollection.prototype.dispose = function() {
        this.removeAll();
        this._billboardCollection = this._billboardCollection.dispose();
        this._textureAtlas = this._textureAtlas && this._textureAtlas.dispose();
        this._backgroundBillboardCollection = this._backgroundBillboardCollection.dispose();
        this._backgroundTextureAtlas = this._backgroundTextureAtlas && this._backgroundTextureAtlas.dispose();
