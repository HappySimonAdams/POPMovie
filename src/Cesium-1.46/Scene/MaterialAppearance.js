define([
        ...
        '../Core/freezeObject',
        '../Core/VertexFormat',
        '../Shaders/AllMaterialAppearanceFS',
        '../Shaders/AllMaterialAppearanceVS',
        '../Shaders/BasicMaterialAppearanceFS',
        '../Shaders/BasicMaterialAppearanceVS',
        '../Shaders/TexturedMaterialAppearanceFS',
        '../Shaders/TexturedMaterialAppearanceVS',
        './Appearance',
        './Material'
    ], function(
        defaultValue,
