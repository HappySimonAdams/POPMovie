define([
        ...
        '../GltfPipeline/addDefaults',
        '../GltfPipeline/addPipelineExtras',
        '../GltfPipeline/ForEach',
        '../GltfPipeline/getAccessorByteStride',
        '../GltfPipeline/numberOfComponentsForType',
        '../GltfPipeline/parseBinaryGltf',
        '../GltfPipeline/processModelMaterialsCommon',
        '../GltfPipeline/processPbrMetallicRoughness',
        '../GltfPipeline/updateVersion',
        '../ThirdParty/Uri',
        '../ThirdParty/when',
        './AttributeType',
        './Axis',
    ...
    Model.prototype.update = function(frameState) {
        ...
        if ((this._state === ModelState.NEEDS_LOAD) && defined(this.gltf)) {
            ...
            } else { // cache key not given? this model doesn't care about context level cache at all. Cache is here to simplify freeing on dispose.
    ...
    function regenerateShaders(model, frameState) {
        ...
        // - do NOT dispose any programs - might be used by copies of the model or by might be needed in the future if clipping planes/model color is deactivated

        // If clipping planes and model color inactive:
        // - dispose _rendererResources.*programs
     ...
     *
     * @example
     * model = model && model.dispose();
     *
     * @see Model#isDestroyed
     */
    Model.prototype.dispose = function() {
        // Vertex arrays are unique to this model, dispose here.
        if (defined(this._precreatedAttributes)) {
        ...
        // Shaders modified for clipping and for color don't get cached, so dispose these manually
        ...
        // Only dispose the ClippingPlaneCollection if this is the owner - if this model is part of a Cesium3DTileset,
        ...
        if (defined(clippingPlaneCollection) && !clippingPlaneCollection.isDestroyed() && clippingPlaneCollection.owner === this) {
            clippingPlaneCollection.dispose();
        }
        this._clippingPlanes = undefined;
