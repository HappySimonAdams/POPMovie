define([
    ...
    function releaseResources(stage) {
        if (defined(stage._command)) {
            stage._command.shaderProgram = stage._command.shaderProgram && stage._command.shaderProgram.dispose();
     ...
     */
    PostProcessStage.prototype.dispose = function() {
        releaseResources(this);
