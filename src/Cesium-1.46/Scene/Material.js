define([
        ...
        '../Renderer/CubeMap',
        '../Renderer/Texture',
        '../Shaders/BumpMapMaterial',
        '../Shaders/CheckerboardMaterial',
        '../Shaders/DotMaterial',
        '../Shaders/ElevationContourMaterial',
        '../Shaders/ElevationRampMaterial',
        '../Shaders/FadeMaterial',
        '../Shaders/GridMaterial',
        '../Shaders/NormalMapMaterial',
        '../Shaders/PolylineArrowMaterial',
        '../Shaders/PolylineDashMaterial',
        '../Shaders/PolylineGlowMaterial',
        '../Shaders/PolylineOutlineMaterial',
        '../Shaders/RimLightingMaterial',
        '../Shaders/SlopeRampMaterial',
        '../Shaders/StripeMaterial',
        '../Shaders/Water',
        '../ThirdParty/when'
    ], function(
        Cartesian2,
