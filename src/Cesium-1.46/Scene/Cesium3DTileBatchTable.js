define([
    ...
    Cesium3DTileBatchTable.prototype.dispose = function() {
        this._batchTexture = this._batchTexture && this._batchTexture.dispose();
        this._pickTexture = this._pickTexture && this._pickTexture.dispose();
