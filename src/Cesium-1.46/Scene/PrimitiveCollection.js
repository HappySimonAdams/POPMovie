define([
    ...
    function PrimitiveCollection(options) {
         ...
         * primitives = primitives.dispose();
         * var b = labels.isDestroyed(); // true
         *
         * @example
         * // Example 2. Do not dispose primitives in a collection.
         * var primitives = new Cesium.PrimitiveCollection();
         * primitives.destroyPrimitives = false;
         * var labels = primitives.add(new Cesium.LabelCollection());
         * primitives = primitives.dispose();
         * var b = labels.isDestroyed(); // false
         * labels = labels.dispose();    // explicitly dispose
         */
     ...
     * collector to dispose this collection.
     * <br /><br />
     * Since destroying a collection destroys all the contained primitives, only dispose a collection
     ...
     *
     * @example
     * primitives = primitives && primitives.dispose();
     *
     * @see PrimitiveCollection#isDestroyed
     */
    PrimitiveCollection.prototype.dispose = function() {
        this.removeAll();
