define([
        ...
        if (hasWaterMask && this._oceanNormalMapResourceDirty) {
            ...
            if (defined(oceanNormalMapUrl)) {
                ...
                when(oceanNormalMapResource.fetchImage(), function(image) {
                    ...
                    that._oceanNormalMap = that._oceanNormalMap && that._oceanNormalMap.dispose();
                ...
                this._oceanNormalMap = this._oceanNormalMap && this._oceanNormalMap.dispose();
            }
        }
     ...
     *
     * @example
     * globe = globe && globe.dispose();
     *
     * @see Globe#isDestroyed
     */
    Globe.prototype.dispose = function() {
        this._surfaceShaderSet = this._surfaceShaderSet && this._surfaceShaderSet.dispose();
        this._surface = this._surface && this._surface.dispose();
        this._oceanNormalMap = this._oceanNormalMap && this._oceanNormalMap.dispose();
