define([
        ...
        '../Scene/BlendingState',
        '../Shaders/PointCloudEyeDomeLighting'
    ], function(
        Cartesian3,
        Color,
        defined,
    ...
    function destroyFramebuffer(processor) {
        ...
        processor._colorTexture.dispose();
        processor._ecAndLogDepthTexture.dispose();
        processor._depthTexture.dispose();
        framebuffer.dispose();
     ...
     *
     * @example
     * processor = processor && processor.dispose();
     *
     * @see PointCloudEyeDomeLighting#isDestroyed
     */
    PointCloudEyeDomeLighting.prototype.dispose = function() {
