define([
    ...
    function destroyResources(post) {
        post._framebuffer = post._framebuffer && post._framebuffer.dispose();
        post._colorTexture = post._colorTexture && post._colorTexture.dispose();
        post._depthStencilTexture = post._depthStencilTexture && post._depthStencilTexture.dispose();
        post._depthStencilRenderbuffer = post._depthStencilRenderbuffer && post._depthStencilRenderbuffer.dispose();
    ...
    SceneFramebuffer.prototype.update = function(context) {
        ...
        if (textureChanged) {
            this._colorTexture = this._colorTexture && this._colorTexture.dispose();
            this._depthStencilTexture = this._depthStencilTexture && this._depthStencilTexture.dispose();
            this._depthStencilRenderbuffer = this._depthStencilRenderbuffer && this._depthStencilRenderbuffer.dispose();
        ...
        if (!defined(this._framebuffer) || textureChanged) {
            this._framebuffer = this._framebuffer && this._framebuffer.dispose();
    ...
    SceneFramebuffer.prototype.dispose = function() {
