define([
        ...
        '../Core/VertexFormat',
        '../Shaders/PerInstanceColorAppearanceFS',
        '../Shaders/PerInstanceColorAppearanceVS',
        '../Shaders/PerInstanceFlatColorAppearanceFS',
        '../Shaders/PerInstanceFlatColorAppearanceVS',
        './Appearance'
    ], function(
        defaultValue,
        defineProperties,
