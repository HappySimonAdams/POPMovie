define([
    ...
    Vector3DTileContent.prototype.dispose = function() {
        this._polygons = this._polygons && this._polygons.dispose();
        this._polylines = this._polylines && this._polylines.dispose();
        this._points = this._points && this._points.dispose();
