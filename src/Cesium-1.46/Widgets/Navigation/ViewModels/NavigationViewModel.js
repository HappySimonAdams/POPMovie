define([
    ...
    NavigationViewModel.prototype.dispose = function () {
    ...
    NavigationViewModel.prototype.show = function (container) {
        ...
        if (this.enableZoomControls && this.enableCompass) {
            testing = '<div class="compass" title="拖动外圈旋转视角，也可通过ctrl+鼠标左键控制视角" data-bind="visible: showCompass, event: { mousedown: handleMouseDown, dblclick: handleDoubleClick }">' +
                ...
                ' <div class="compass-outer-ring" title="点击拖动改变相机视角" data-bind="style: { transform: \'rotate(-\' + heading + \'rad)\', \'-webkit-transform\': \'rotate(-\' + heading + \'rad)\' }, cesiumSvgPath: { path: svgCompassOuterRing, width: 145, height: 145 }"></div>' +
    ...
    function orbit(viewModel, compassElement, cursorVector) {
        ...
        viewModel.orbitTickFunction = function (e) {
            ...
            // viewModel.terria.notifyRepaintRequired();
    ...
    function rotate(viewModel, compassElement, cursorVector) {
        viewModel.terria.options.enableCompassOuterRing = (defined(viewModel.terria.options.enableCompassOuterRing)) ? viewModel.terria.options.enableCompassOuterRing : true;
