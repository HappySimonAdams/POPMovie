define([
    ...
    Framebuffer.prototype.dispose = function() {
        if (this.destroyAttachments) {
            ...
            this._depthTexture = this._depthTexture && this._depthTexture.dispose();
            this._depthRenderbuffer = this._depthRenderbuffer && this._depthRenderbuffer.dispose();
            this._stencilRenderbuffer = this._stencilRenderbuffer && this._stencilRenderbuffer.dispose();
