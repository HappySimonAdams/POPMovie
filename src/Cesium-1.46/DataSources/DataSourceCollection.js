define([
     ...
     * @param {Boolean} [destroy=false] Whether to dispose the data source in addition to removing it.
    ...
    DataSourceCollection.prototype.remove = function(dataSource, destroy) {
        ...
        if (index !== -1) {
            ...
            if (destroy && typeof dataSource.dispose === 'function') {
                dataSource.dispose();
            }
     ...
     *
     * @param {Boolean} [destroy=false] whether to dispose the data sources in addition to removing them.
     */
     ...
     *
     * @example
     * dataSourceCollection = dataSourceCollection && dataSourceCollection.dispose();
     *
     * @see DataSourceCollection#isDestroyed
     */
    DataSourceCollection.prototype.dispose = function() {
        this.removeAll(true);
