define([
    ...
    *
    */
    EntityView.prototype.update = function(time, boundingSphere, headingPitchRange) {   // TODO: 自定义增加了headingPitchRange参数
        ...
        if (objectChanged) {
            ...
            if (!hasViewFrom && defined(boundingSphere)) {
                ...
                if (defined(headingPitchRange)) {
                    scratchHeadingPitchRange = headingPitchRange;
                } else {
                    // scratchHeadingPitchRange.pitch = -CesiumMath.PI_OVER_FOUR;
                    // scratchHeadingPitchRange.range = 0;
                    scratchHeadingPitchRange.pitch = CesiumMath.toRadians(-12);
                    scratchHeadingPitchRange.range = 0;
                }
