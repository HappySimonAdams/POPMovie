define([
    ...
    function updateEnable(entityCluster) {
        ...
        if (defined(entityCluster._clusterLabelCollection)) {
            entityCluster._clusterLabelCollection.dispose();
        }
        if (defined(entityCluster._clusterBillboardCollection)) {
            entityCluster._clusterBillboardCollection.dispose();
        }
        if (defined(entityCluster._clusterPointCollection)) {
            entityCluster._clusterPointCollection.dispose();
        }
     ...
     * </p>
     */
    EntityCluster.prototype.dispose = function() {
        this._labelCollection = this._labelCollection && this._labelCollection.dispose();
        this._billboardCollection = this._billboardCollection && this._billboardCollection.dispose();
        this._pointCollection = this._pointCollection && this._pointCollection.dispose();

        this._clusterLabelCollection = this._clusterLabelCollection && this._clusterLabelCollection.dispose();
        this._clusterBillboardCollection = this._clusterBillboardCollection && this._clusterBillboardCollection.dispose();
        this._clusterPointCollection = this._clusterPointCollection && this._clusterPointCollection.dispose();
